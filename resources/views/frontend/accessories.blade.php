        ...
        <div class="row">
            ...
            <aside class="sidebar-shop col-lg-3 order-lg-first">
                <div class="sidebar-wrapper">
                    ...
                    <div class="widget" id="main_category_show">
                        <h3 class="widget-title">
                            <a data-toggle="collapse" href="#widget-body-14" role="button" aria-expanded="true" aria-controls="widget-body-4">Category</a>
                        </h3>
                            ...
                            <div class="widget-body">
                                <ul class="cat-list" style="overflow: auto;max-height: 200px;" id="brand_list">
                                    @foreach ($maincategory as $item)
                                        <li class="text-dark"><input type="radio" name="maincategory" value="{{ $item->id }}"> {{ $item->name }}</li>
                                    @endforeach
                                </ul>
                            </div><!-- End .widget-body -->
                        </div><!-- End .collapse -->
                ...
                if(res[1].last_page > 1){
                    if (res[1] != null){
                        ...
                        for (var i = 1; i <=res[1].last_page; i++){
                            ...
                            pag+="<a class='page-link page-b-click' href='"+site_url+"/acc-filter?page="+i+"' data-url='"+site_url+"/acc-filter?page="+i+"'>"+i+"</a>"
                            pag+="</li>"
                        }
...
// $('.cat-list').on('click','li > input[name="price"]',function(){
//     price = $(this).prop('checked', true).val();
// });

$('.sidebar-wrapper').on('change','input[type="radio"], input[type="checkbox"]', function (e) {
    var site_url = $('#index').attr('href');
